...
list_barcode_index = ['36'] # '013', '021', '022', '023', '031', '041', '042', '052', '082', '111', '122', '280',
                      #'373', '380', '430', '440', '450']
...
def get_barcode_from_fake_images() -> list:
    ...
    fake_images_path = '/mnt/d/AIVI_FCM/Redrabbit/*.jpeg'

    #print(fake_images_path)
    
    files = []
    #myrootdir = os.getcwd()
    myrootdir = fake_images_path
    seen = []


    for path in sorted(list(iglob(myrootdir))):
...
def main():
    ...
    # variable for line 1
    #barcode_value_line1_station1_init = generate_random_barcode()
    ...
    #while True:
        ...
        #barcode_value_line1_station1 = generate_random_barcode()
        barcode_value_line1_station1 = barcode_value_line1_station1_init[count]
        print(f'New barcode on station 1: {count} {barcode_value_line1_station1}')
        ...
        time.sleep(1)
        #count = (count +1 ) % len(barcode_value_line1_station1_init)
